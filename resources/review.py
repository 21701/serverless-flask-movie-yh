...
class ReviewResource(Resource) :
    ...
    def post(self) :
        ...
        # 클라이언트가 보낸 정보 (body의 json)받아오기
        data = request.get_json()
        # {"movie_id": 1, "rating" : 5, "content" : "재미없어"}
        ...
        try :
            ...
            # 써준다.
            record = (user_id, data['movie_id'], data['rating'],data['content'])
    ...
    def get(self) :
        ...
        return { "count" : len(record_list)  , "review_list" : record_list }
